document.addEventListener("DOMContentLoaded", async () => {
    ...
    try{
        ...
        const response = await fetch('http://localhost:5000/view/exampapers', {
        ...
        if(response.ok){
            ...
            if(files.length > 0){
                ...
                uploadedImagesContainer.innerHTML = "<p> No Exam Papers Found </p>";
...
async function deleteCard(id, cardElement){
    ...
    if(confirm("Are you sure you want to delete this item?")){
        ...
        try{
            ...
            const response = await fetch(`http://localhost:5000/delete/exampapers`, {
